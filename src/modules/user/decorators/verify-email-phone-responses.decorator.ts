...
import { ChangeEmailAndPhoneSuccess, VerifyEmailAndPhoneSuccess } from "../responses/success.response";
 ...
 */
export function ApiVerifyEmailAndPhoneResponses() {
	/**
	...
	return function (
		...
		ApiOkResponse({
			...
			type: VerifyEmailAndPhoneSuccess,
		})(target, propertyKey, descriptor);

		/**
		 * Indicates a bad request error with status code 400.
		 */
		ApiBadRequestResponse({
